...
Service detection performed.` });
  ...
  function buildLauncherBat(version, consoleUrl, bundleUrl, siteOrigin) {
    return [
      ...
      "echo ==================================================",
      `echo   AetherScan ${version} - setting up`,
      ...
      "echo.",
      "echo AetherScan is running. Your browser should open the console.",
      "echo To stop: Task Manager > pythonw.exe > End Task",
      "timeout /t 2 >nul",
      "exit /b 0",
      ":fail",
